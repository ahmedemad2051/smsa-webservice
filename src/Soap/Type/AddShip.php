...
/**
 * This class stands for addShipment Type
 *
 * @date 2018/04/06
 * @codeVersion 0.0.1
 */
class AddShip extends AbstractStructBase
{
     ...
     *
     * @uses AddShipment::setPCs()
     * @uses AddShipment::setPassKey()
     * @uses AddShipment::setRefNo()
     * @uses AddShipment::setSentDate()
     * @uses AddShipment::setIdNo()
     * @uses AddShipment::setCName()
     * @uses AddShipment::setCntry()
     * @uses AddShipment::setCCity()
     * @uses AddShipment::setCZip()
     * @uses AddShipment::setCPOBox()
     * @uses AddShipment::setCMobile()
     * @uses AddShipment::setCTel1()
     * @uses AddShipment::setCTel2()
     * @uses AddShipment::setCAddr1()
     * @uses AddShipment::setCAddr2()
     * @uses AddShipment::setShipType()
     * @uses AddShipment::setCEmail()
     * @uses AddShipment::setCarrValue()
     * @uses AddShipment::setCarrCurr()
     * @uses AddShipment::setCodAmt()
     * @uses AddShipment::setWeight()
     * @uses AddShipment::setCustVal()
     * @uses AddShipment::setCustCurr()
     * @uses AddShipment::setInsrAmt()
     * @uses AddShipment::setInsrCurr()
     * @uses AddShipment::setItemDesc()
     *
     * @param int    $pCs
